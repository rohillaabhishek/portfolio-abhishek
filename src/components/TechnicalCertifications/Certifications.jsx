    ...
    <section className="section pin-section" id="certification" ref={sectionRef}>
      ...
      <div className="content">
        <ul className="certification-list">
          <li>Java DSA Masterclass</li>
          <li>Complete Python Developer</li>
          <li>Enterprise-grade AI Basics</li>
        ...
        <div className="right">
          <div className="slide center">
            <img src="/assets/images/certificates/certificate-1.png" alt="" />
          </div>
          <div className="slide center">
            <img src="/assets/images/certificates/certificate-2.png" alt="" />
          </div>
          <div className="slide center">
            <img src="/assets/images/certificates/certificate-3.png" alt="" />
          </div>
          <div className="slide center">
            <img src="/assets/images/certificates/certificate-4.png" alt="" />
          </div>
          <div className="slide center">
            <img src="/assets/images/certificates/certificate-5.png" alt="" />
          </div>
        </div>
      </div>
    </section>
