...
const expressjsIcon = "/assets/images/tech-icons/expressjs.svg"
...
const gitIcon = "/assets/images/tech-icons/git.svg"
const githubIcon = "/assets/images/tech-icons/github.svg"
...
const SECTIONS = [
  {
    label: "FRONTEND",
    techs: ["React.js", "HTML 5", "CSS 3", "JavaScript", "Tailwind CSS", "GSAP"],
  },
  {
    label: "BACKEND",
  ...
  {
    label: "LANGUAGES",
    techs: ["JavaScript", "Core Java", "Python", ],
  },
  {
    label: "TOOLS",
    techs: ["Git", "GitHub", "Postman", "VS Code", "IntelliJ IDEA"],
  },
